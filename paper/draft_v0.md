...
($+0.104$ nats improvement from forced diversity at $r=6$). We introduce an entropy-based
...
*End of draft v1. All sections complete.*  
*Next: LaTeX formatting, venue selection, author review round 2.*
