...
supervision or defense. **"Research monograph" (or "technical report") is the accurate
designation** — the `dissertation_draft` directory name is historical; this is not a doctoral
