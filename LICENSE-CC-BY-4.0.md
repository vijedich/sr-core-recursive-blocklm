...
- `dissertation/docs/dissertation_draft/` — Research Monograph
- `paper/` — Paper drafts
...
b. **Licensed Material** means the artistic or literary work, database, or other material to
   which the Licensor applied this Public License.

c. **Licensed Rights** means the rights granted to You subject to the terms and conditions of
...
b. *Attribution.* If You Share the Licensed Material (including in modified form), You must:
   ...
   1. retain the following if it is supplied by the Licensor with the Licensed Material:
      - identification of the creator(s) of the Licensed Material: **Viktor Jedich**
      - a copyright notice: Copyright (c) 2026 Viktor Jedich
      - a notice that refers to this Public License
      - a URI or hyperlink to the Licensed Material, to the extent reasonably practicable
   2. indicate if You modified the Licensed Material and retain an indication of any previous
      modifications; and
   3. indicate the Licensed Material is licensed under this Public License.

**Section 3 — No additional restrictions.**
